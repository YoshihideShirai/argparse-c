...
![Animated terminal demo showing `argparse-c` surfacing help output, shell completion candidates, and friendly validation errors from one sample parser definition.](./docs/repository/assets/argparse-c-demo.gif)
...
- [`sample/example_test_runner.c`](./sample/example_test_runner.c): minimal sample for unit-test-style argument parsing verification
